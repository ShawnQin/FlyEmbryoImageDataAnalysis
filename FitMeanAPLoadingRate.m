function FitMeanAPLoadingRate(varargin)

%modified from 'FitMeanAPAssymetric.m', manualy choose the range to do linear fitting
...
%or nc14
if exist([DropboxFolder,filesep,Prefix,filesep,'MeanFitsLoadingRate.mat'])
    load([DropboxFolder,filesep,Prefix,filesep,'MeanFitsLoadingRate.mat']);
...
save([DropboxFolder,filesep,Prefix,filesep,'MeanFitsLoadingRate.mat'],...
    'FitResults')
