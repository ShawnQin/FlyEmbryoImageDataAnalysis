function [TimeRange,Fluorescence]=FluorescenceCurveV0(ncLength,TimeStart,TimeEnd,Rate,Elongation,GeneLength)

%Modified from FluorescenceCurve.m
%This function outputs a standard fluorescent trace given a transcription
%rate, a start time, a transcription rate, gene length and an end time.
