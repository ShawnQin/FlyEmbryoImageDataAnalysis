function chi2=lsqnonlinFitFluorescenceCurveV3(TimeData,FluoData,GeneLength,ncLength,x0)

%V3" Now use different elongation rate to determine the Delay time
